...
<header class="c-header">
    <div class="container container--responsive container--white">
        <div class="c-header__row ">
            <div class="c-header__right">
                <div class="logo">
                    <a href="{{url('/')}}" class="logo__img"></a>
                </div>
                <div class="c-search width-100 ">
                    <form action="{{route('search')}}" class="c-search__form position-relative">
    ...
    <nav class="nav" id="nav">
        ...
        <div class="container container--nav">
            <ul class="nav__ul">
                <li class="nav__item"><a href="{{url('/')}}" class="nav__link">صفحه اصلی</a></li>
                            ...
                            <div class="nav__sub">
                                <div class="container d-flex item-center flex-wrap container--nav">
                                    @foreach($category->childs as $child)
                                        <a href="{{route('category.show',$child->slug)}}" class="nav__link">{{$child->name}}</a>
                                    @endforeach
                                </div>
                            </div>
                        @endif
